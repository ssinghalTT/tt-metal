...
std::vector<ttnn::TensorSpec> TilizeWithValPadding::compute_output_specs(
    ...
    // This behavior is a bit strange, but preserving as-is for now
    auto output_logical_shape = input_tensor.get_padded_shape();
    ...
    return {TensorSpec(
        ...
        TensorLayout::fromPaddedShape(
            output_dtype, PageConfig(Layout::TILE), mem_config, output_logical_shape, output_padded_shape))};
}
