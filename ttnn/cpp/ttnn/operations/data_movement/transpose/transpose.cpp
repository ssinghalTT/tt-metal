...
ttnn::Tensor ExecuteTranspose::invoke(
    ...
    auto output_tensors = [normalized_dim1, normalized_dim2, memory_config_arg, pad_value](
                              const std::vector<Tensor>& input_tensors) mutable -> std::vector<Tensor> {
        ...
        if ((normalized_dim1 == normalized_dim2) ||
            ...
            return {
                ttnn::operations::experimental::auto_format::AutoFormat::move_tensor_to_mem_config(a, memory_config)};
        }
