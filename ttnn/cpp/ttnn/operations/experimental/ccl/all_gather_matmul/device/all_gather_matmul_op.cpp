...
std::vector <ttnn::Tensor> all_gather_matmul(
    ...
    operation::launch_op(
        [dim, all_gather_core_grid_offset, num_links, memory_config_ag, user_defined_num_workers, user_defined_num_buffers_per_channel, memory_config_mm, transpose_a, transpose_b, dtype, program_config, activation, compute_kernel_config, core_grid, devices, topology](
            ...
            /* AllGather setup */
            ttnn::AllGather all_gather_struct = ttnn::ccl::all_gather_detail::create_all_gather_struct(input_tensor, dim, num_links, memory_config_ag, user_defined_num_workers, user_defined_num_buffers_per_channel, devices, topology, ttnn::ccl::OpFabricMode::NON_PERSISTENT);
