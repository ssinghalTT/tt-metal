...
@pytest.mark.parametrize("device_params", [{"l1_small_size": 16384}], indirect=True)
@pytest.mark.parametrize(
    "batch_size, input_channels, output_channels, input_height, input_width, filter_height, filter_width, stride_h, stride_w, pad_h, pad_w, groups, use_1d_systolic_array, config_override, use_shallow_conv_variant, auto_shard",
    (
        # (1, 3, 16, 640, 640, 3, 3, 2, 2, 1, 1, 1, True, None, False, True),
        # (1, 16, 32, 320, 320, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.9998
        # (1, 32, 32, 160, 160, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.999904, 0.99988, 0.999990, 0.9999656
        # (1, 16, 16, 160, 160, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.9997,  0.9997,  0.9998, 0.999879
        # (1, 48, 32, 160, 160, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.9999, 0.9998,  0.99998, 0.99996
        # (1, 32, 64, 160, 160, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.9997, 0.99972, 0.9998, 0.9998
        # (1, 64, 64, 80, 80, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99989, 0.99987, 0.999986, 0.99996
        # (1, 32, 32, 80, 80, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99974, 0.99972, 0.99988, 0.99986
        # (1, 128, 64, 80, 80, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99989, 0.99987, 0.99997,  0.99995
        # (1, 64, 128, 80, 80, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.99972, 0.99971,  0.99986, 0.99984
        # (1, 128, 128, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.9998, 0.99976, 0.99997, 0.999953
        # (1, 64, 64, 40, 40, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99972, 0.99971, 0.99986, 0.99984
        # (1, 256, 128, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99988, 0.99978, 0.99997, 0.99994
        # (1, 128, 256, 40, 40, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.99962, 0.99961, 0.99982, 0.99980
        # (1, 256, 256, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99996, 0.99994, 0.99996, 0.99994
        # (1, 128, 128, 20, 20, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.9996, 0.99960, 0.9998, 0.99980
        # (1, 384, 256, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99994, 0.99992, 0.99994,  0.99992
        # (1, 256, 128, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99996, 0.99994, 0.99996, 0.99994
        # (1, 512, 256, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99992, 0.99990,  0.99992, 0.99990
        # (1, 384, 128, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99988, 0.99978, 0.99997, 0.99994
        # (1, 192, 128, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99989,  0.999789,  0.99997,  0.9999
        # (1, 192, 64, 80, 80, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99988, 0.99986, 0.99997, 0.99994
        # (1, 32, 32, 80, 80, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99974, 0.99972, 0.99988, 0.99986
        # (1, 96, 64, 80, 80, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99989, 0.99987, 0.99998, 0.99995
        # (1, 64, 64, 80, 80, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.99972, 0.99971, 0.99986, 0.999847
        # (1, 192, 128, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99989, 0.99978, 0.99997, 0.99995
        # (1, 128, 128, 40, 40, 3, 3, 2, 2, 1, 1, 1, True, None, False, True), #0.999625, 0.99960, 0.999820, 0.999803
        # (1, 64, 64, 80, 80, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), # 0.99972, 0.99970, 0.99986, 0.999847
        # (1, 80, 80, 80, 80, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99971, 0.99969, 0.999857, 0.99983
        # (1, 128, 64, 40, 40, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), # 0.999666, 0.99964, 0.99982, 0.99980
        # (1, 64, 64, 40, 40, 1, 1, 1, 1, 1, 1, 1, True, None, False, True), #0.99980, 0.99978, 0.99988, 0.99987
        # (1, 80, 40, 40, 40, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99971, 0.99970, 0.99985, 0.99984
        # (1, 80, 80, 40, 40, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.99990, 0.99979,  0.99998, 0.99996
        # (1, 256, 64, 20, 20, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.9995, 0.99954, 0.99969, 0.99967
        # (1, 64, 64, 20, 20, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), # 0.99976,  0.99974, 0.99987, 0.99985
        # (1, 64, 64, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.999986, 0.99996, 0.99998, 0.999963
        # (1, 256, 80, 20, 20, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99952, 0.99950, 0.99970, 0.99967
        # (1, 80, 80, 20, 20, 3, 3, 1, 1, 1, 1, 1, True, None, False, True), #0.99971, 0.99969, 0.99985, 0.999837
        # (1, 80, 80, 20, 20, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.999984, 0.99995, 0.999984, 0.999959
        # (1, 16, 1, 4, 8400, 1, 1, 1, 1, 0, 0, 1, True, None, False, True), #0.999960, 0.999958, 0.9999929, 0.999990
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
