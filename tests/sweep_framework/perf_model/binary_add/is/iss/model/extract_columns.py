...
def main():
    # Input file paths
    input_file_path = "/localdev/skrstic/tt-metal/generated/profiler/reports/2024_11_27_12_34_17/ops_perf_results_2024_11_27_12_34_17.csv"
    sharding_file_path = "tests/sweep_framework/perf_model/binary_add/is/iss/model/sharding_configurations.csv"

    # Output file path
    output_file_path = "tests/sweep_framework/perf_model/binary_add/is/iss/model/all_results.csv"
