...
def main():
    # Input file paths
    input_file_path = "/localdev/skrstic/tt-metal/generated/profiler/reports/2024_11_26_15_24_59/ops_perf_results_2024_11_26_15_24_59.csv"
    sharding_file_path = (
        "tests/sweep_framework/perf_model/binary_add/is/iis/moving_rect_different_sizes/sharding_configurations.csv"
    )

    # Output file path
    output_file_path = "tests/sweep_framework/perf_model/binary_add/is/iis/moving_rect_different_sizes/extracted_moving_rectangle_with_sharding.csv"
