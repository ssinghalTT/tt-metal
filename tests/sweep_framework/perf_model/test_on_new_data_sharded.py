...
output_file = "tests/sweep_framework/perf_model/sharded/filtered_rows_new_data.csv"
stats_file = "tests/sweep_framework/perf_model/sharded/kernel_duration_stats.csv"
plots_dir = "tests/sweep_framework/perf_model/sharded/plots"
os.makedirs(plots_dir, exist_ok=True)  # Ensure the plots directory exists

# Load fitting coefficients
fitting_file = "tests/sweep_framework/perf_model/fitting_data_sharded.csv"
fitting_coeffs = {}
...
for key, num_tiles_dict in kernel_durations.items():
    for num_tiles, durations in num_tiles_dict.items():
        ...
        # if (key[0] == 'L1_INTERLEAVED' and key[1] == 'DRAM_INTERLEAVED' and key[2] == 'BFLOAT16' and num_tiles == ):
        #     print("hej")
