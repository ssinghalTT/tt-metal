...
MAKE_ANY_RANGE(SizedCircularBufferRange, stl::AnySizedInputRange<CircularBufferHandle, 24>);

MAKE_ANY_RANGE(CircularBufferRange, stl::AnyInputRange<CircularBufferHandle, 88, 24>);
