 ...
 * bytes_allocatable_per_bank: total allocatable size per bank of dram in bytes
 * bytes_allocated_per_bank: currently allocated size per bank of dram in bytes
 * bytes_free_per_bank: total free size per bank of dram in bytes
 * total_bytes_allocatable: total allocatable size of dram in bytes
 * total_bytes_allocated: currently allocated size of dram in bytes
 * total_bytes_free: total free size of dram in bytes
 * largest_contiguous_bytes_free_per_bank: largest contiguous free block of dram in bytes
